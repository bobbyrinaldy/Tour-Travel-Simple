             ...
             <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/admin/paket/hotel/{{$hotel->id}}/update" method="post">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="nama" name="paket_id" value="{{$hotel->package_id}}" required="required" class="form-control col-md-7 col-xs-12" readonly>
                 </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   ...
                   <input id="harga" class="form-control col-md-7 col-xs-12" type="hidden" name="harga" placeholder="0" value="{{$hotel->harga}}">
                 </div>
               </div>
