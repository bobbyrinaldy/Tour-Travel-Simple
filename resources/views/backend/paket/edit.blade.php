...
@include('backend/editor/header')
  ...
  <div class="x_panel">
           ...
           <div class="x_content">
             <br />
             <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/admin/paket/update/{{$p->id}}" method="post" enctype="multipart/form-data">
               {{ csrf_field() }}
               <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nama Paket <span class="required">*</span>
                 </label>
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="nama" name="nama_paket" required="required" class="form-control col-md-7 col-xs-12" value="{{$p->nama_paket}}">
                 </div>
               </div>
               <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="tujuan" name="tujuan" required="required" class="form-control col-md-7 col-xs-12" value="{{$p->tujuan}}">
                 </div>
               </div>
               <div class="form-group">
                 <label for="harga" class="control-label col-md-3 col-sm-3 col-xs-12">Harga (Rp.)</label>
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input id="show_harga" class="form-control col-md-7 col-xs-12" type="text" name="" placeholder="0" value="{{$p->harga}}">
                   <input id="harga" class="form-control col-md-7 col-xs-12" type="hidden" name="harga" placeholder="0" value="{{$p->harga}}">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <textarea name="keterangan" class="form-control col-md-7 col-xs-12" rows="8" cols="80" id="keterangan">{{$p->keterangan}}</textarea>
                 </div>
               </div>
